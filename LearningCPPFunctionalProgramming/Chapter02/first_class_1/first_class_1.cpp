...
// Defining a type of function named FuncType representing a function
// that pass two int arguments and return an int value
...
auto main() -> int {
    ...
    // Preventing user to select unavailable modes
    if(i < 1 || i > 4) {
