...
auto main() -> int
{
    ...
    // Displaying the elements of the vector which are the two-wheeled vehicles
    cout << "Two-wheeled vehicle(s):" << endl;;
    auto tw = find_if(begin(vehicles), end(vehicles), TwoWheeled);
    ...
    // Displaying the elements of the vector which are not the two-wheeled vehicles
