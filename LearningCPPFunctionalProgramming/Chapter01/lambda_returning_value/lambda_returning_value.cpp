...
auto main() -> int
{
    ...
    transform(begin(vect), end(vect), begin(vect2),
            [](int n) {
                return n * n;
            });
    ...
    for_each(begin(vect2), end(vect2),
            [](int n) {
                cout << n << " ";
            });
    cout << endl;
    ...
    // Finding the average of the elements of vect and store to vect2
    ...
    for_each(begin(vect3), end(vect3),
            [](double d) {
                cout << d << " ";
            });
    cout << endl;
