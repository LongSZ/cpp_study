// fig12_02.cpp
// Example that throws an exception on an attempt to divide by zero.
#include <iostream>
...
int main() {
    ...
    while (cin >> number1 >> number2) {
        // try block contains code that might throw exception and code that will not execute if an exception occurs    
        try {                                                       
