...
private:
   mutable std::binary_semaphore m_produce{1}; // producer can produce
   mutable std::binary_semaphore m_consume{0}; // consumer can't consume
   mutable bool m_occupied{false}; // mutable for modification in get()
