...
int main() {
    ...
    std::cout << fmt::format("{}\n{}{}\n{}{}\n\n",
        ...
        "std::is_same_v<int, my_remove_ptr<int>::type>: ", std::is_same_v<int, my_remove_ptr<int>::type>,
        "std::is_same_v<int, my_remove_ptr<int*>::type>: ", std::is_same_v<int, my_remove_ptr<int*>::type>);
    
    std::cout << fmt::format("{}\n{}{}\n{}{}\n\n",
        "ADD REFERENCES TO TYPES USING STANDARD TYPE TRAITS",
        "std::is_same_v<int&, std::add_lvalue_reference<int>::type>: ", std::is_same_v<int&, std::add_lvalue_reference<int>::type>,
        "std::is_same_v<int&&, std::add_rvalue_reference<int>::type>: ", std::is_same_v<int&&, std::add_rvalue_reference<int>::type>);
    
    std::cout << fmt::format("{}\n{}{}\n{}{}\n{}{}\n",
        "REMOVE REFERENCES FROM TYPES USING STANDARD TYPE TRAITS",
        "std::is_same_v<int, std::remove_reference<int>::type>: ", std::is_same_v<int, std::remove_reference<int>::type>,
        "std::is_same_v<int, std::remove_reference<int&>::type>: ", std::is_same_v<int, std::remove_reference<int&>::type>,
        "std::is_same_v<int, std::remove_reference<int&&>::type>: ", std::is_same_v<int, std::remove_reference<int&&>::type>);
}
