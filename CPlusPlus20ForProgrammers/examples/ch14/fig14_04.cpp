...
int main() {
    ...
    const auto& [begin1, end1] {std::ranges::remove(v1, 10)};
    v1.erase(begin1, end1);
    ...
    const auto &[begin2, end2]{std::ranges::remove_if(v3, greaterThan9)};
    v3.erase(begin2, end2);
    ...
    std::vector<int> c2{}; // initialize to 0s
