// fig14_12.cpp
// Algorithms lower_bound, upper_bound and equal_range for a sorted sequence of values.
#include <iostream>
...
int main() {
    ...
    std::cout << "\n   Lower bound of 3 is index: " << (lower - values.begin());
    ...
    std::cout << "\n   Upper bound of 7 is index: " << (upper - values.begin());
} 
