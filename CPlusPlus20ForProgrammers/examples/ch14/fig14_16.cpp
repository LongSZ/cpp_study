...
// binary function returns the sum of its first argument total and the square of its second argument value
int sumSquares(int total, int value) {                       
    return total + value * value;                             
}                               

// class SumSquaresClass defines overloaded operator()
// that returns the sum of its first argument total and the square of its second argument value               
...
int main() {
    ...
    // calculate sum of squares of elements of array integers using binary function sumSquares                      
    int result{std::accumulate(integers.cbegin(), integers.cend(), 0, sumSquares)};
    std::cout << "\n\nSum of squares \nvia binary function sumSquares: " << result;
    
    // calculate sum of squares of elements of array integers using binary function object                           
    ...
    result = std::accumulate(integers.cbegin(), integers.cend(), 0, [](auto total, auto value) {return total + value * value; });
    std::cout << "\nvia a lambda: " << result << "\n";
} 
